...
python2 -m pip install hello-robot-stretch-body #git+https://github.com/hello-robot/stretch-body@feature/RE1.5
python2 -m pip install hello-robot-stretch-body-tools
python3 -m pip install hello-robot-stretch-body-tools-py3
python2 -m pip install hello-robot-stretch-factory #git+https://github.com/hello-robot/stretch-factory@feature/RE1.5
